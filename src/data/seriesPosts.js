...
export const SERIES_POSTS = [
  ...
  },
  {
    ...
    body: [
      ...
      { type: 'h2', text: 'What to take away' },
      { type: 'p', text: 'Decide which of the three you are optimizing for before you tune anything, because you cannot have the best of all three. Most user-facing features live or die on latency, so a smaller model and streaming usually beat a bigger, smarter one. Most batch pipelines live or die on cost, so batching and a cheap model win. The team with the sluggish chat did not have a model problem. They had a "we never said which number mattered" problem, and that is the one to solve first.' },
    ],
  },
  {
    id: 'guardrails',
