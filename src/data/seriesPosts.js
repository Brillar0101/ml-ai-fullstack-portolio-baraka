...
export const SERIES_POSTS = [
  ...
  },
  {
    ...
    body: [
      ...
      { type: 'h2', text: 'What to take away' },
      { type: 'p', text: 'Read entropy and cross-entropy as measures of surprise, the same surprise you felt guessing "coffee" easily and the random number not at all. Lower cross-entropy means the model saw the answer coming, training is the act of lowering it, and perplexity is just a more readable version of the same idea. That single framing, it is all about surprise, demystifies a surprising amount of training and evaluation talk that otherwise sounds like math for its own sake.' },
    ],
  },
  {
