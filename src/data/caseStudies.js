...
export const uhfRfidCaseStudy = {
  ...
  sections: [
    ...
    { type: 'process', title: 'How it was built', steps: [
      ...
      { title: 'The RF board (chip-down)', body: 'The design vision is a chip-down board around a single reader IC: a 50 ohm controlled-impedance feed, a via fence at a fraction of the guided wavelength, a pi match, and a harmonic low-pass filter to the antenna. The trace geometry was computed, not guessed.', image: '/assets/images/uhf-rfid-reader/board-3d.png', imageAlt: '3D render of the chip-down board, component placement on a real PCB outline', bullets: ['50 ohm GCPW, W 0.39 mm and gap 0.25 mm', 'Via fence at 9 mm or less', 'Match and 3rd-order harmonic LPF', '4-layer controlled-impedance stackup'] },
    ]},
