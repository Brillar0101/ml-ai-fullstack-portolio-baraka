export const POST = {
  ...
  body: [
    ...
    { type: 'lab', height: 460,
        ...
        caption: 'The filtered search still returns a best match, scoring 0.16 against 1.00 for a real one. A nearest neighbour is always nearest, which is why a similarity floor matters: without one, a shelf with nothing relevant on it still produces a confident looking answer.',
        code: `import math
